[registrationprint.html](https://github.com/user-attachments/files/29623873/registrationprint.html)
<!DOCTYPE html>
<html>
<head>
 ...
 <style>
   ...
   body::before {
     ...
     color: rgba(246, 244, 244, 0.929);         /* faint watermark */
     position: absolute;
     top: 50%;
     left: 50%;
     transform: translate(-50%, -70%) rotate(-45deg); /* diagonal */
